...
# ⚠️ 開発・サポート終了のお知らせ (Deprecated)

本プロジェクトは、VST2 SDKの利用規約に基づき、開発を完全に終了しました。<br>
リポジトリはアーカイブ（読み取り専用）化されています。<br>

### ⚠️ 二次配布（フォーク等）に関する重要なお知らせ
* 今後、他所で配布されるミラーファイルやフォークされたバイナリについて、開発者は一切の責任を負いません。<br>
* セキュリティリスク（マルウェア混入など）の観点から、<br>
  このリポジトリ(https://github.com/Aios-Ciao/VSThost4aviutl/ )以外からのダウンロードや利用は行わないでください。<br>
